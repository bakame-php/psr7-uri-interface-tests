...
We accept bug reports via issues created on [Github](https://github.com/nyamsprod/psr7-uri-interface-test-suite/issues).
...
- **Always try the [master branch](https://github.com/nyamsprod/psr7-uri-interface-test-suite)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/nyamsprod/psr7-uri-interface-test-suite/pull).
